...
```bash
# Base (con defaults)
python -m portfolio_analyzer.main --input_holdings data/holdings_fineco_021726.csv

# Completo
python -m portfolio_analyzer.main \
...
2. **Gerarchia eccezioni**: `PortfolioAnalyzerError` con sottoclassi specifiche per dati finanziari
