...
from portfolio_analyzer.models.holding import AssetClass, Geography, Holding
...
def _scrape_geo_breakdown(
    ...
    from portfolio_analyzer.data.geo_resolver import resolve_geo
...
def _try_terrapin_fallback(holding: Holding) -> None:
    ...
    try:
        from portfolio_analyzer.data.bond_fetcher import fetch_bond_price, bond_price_to_value
