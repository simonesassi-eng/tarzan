...
from portfolio_analyzer.data.loader import load_holdings, load_config
from portfolio_analyzer.models.portfolio import PortfolioMetrics
from portfolio_analyzer.engine.metrics import MetricsEngine
...
def run(
    ...
    logger.info("Config loaded (threshold=%.1f%%)", config.rebalancing_threshold)

    # 2. Enrich
    from portfolio_analyzer.data.enricher import enrich_holdings, set_portfolio_backtest_period
