...
1. The euro figure is derived from ``performance["1d"]`` itself, not from a
   ...
   session printed "-<amount>" on the 2026-07-29 issue.
...
def test_session_euro_excludes_cash_from_its_base():
    """Real figures from the 2026-07-29 run: <amount> total of which
    <amount> is cash, session -0.175119%.

    -0.175119% of the <amount> priced sleeve is -EUR401. Billing it
    ...
    """
    caption = _session_caption(<amount>.00459144596, <amount>, -0.175119)
